...
/* NOTE: This is a modified version of Dapper, that plays nicely with Serenity.Data and its automatic transaction support */
...
namespace Serenity.Data
{
    ...
    static partial class SqlMapper
    {
        ...
        public static DbType LookupDbType(Type type, string name)
        {
            DbType dbType;
...
this IDbConnection cnn, ISqlQuery sql, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            return Query<T>(cnn, sql.ToString(), sql.Params == null ? null : new DynamicParameters(sql.Params), transaction, buffered, commandTimeout, commandType);
        }
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            var cmd = SqlHelper.NewCommand(cnn, sql);
...
#pragma warning restore 612, 618
    ...
    /// </summary>
    sealed partial class DbString : Serenity.Data.SqlMapper.ICustomQueryParameter
    {
        /// <summary>
